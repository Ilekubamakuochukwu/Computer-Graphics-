...
int speed = 0.1;
int CameraX = 0;
int textureWidthDiff = IMAGE_WIDTH - SCREEN_WIDTH;/Users/anslem/Downloads/Files.zip
...
int main(int argc, char* argv[]) {
    ...
    backgroundTextures.push_back(loadTexture("./Assets/main_background.png"));
   // backgroundTextures.push_back(loadTexture("./Assets/bgrd_tree1.png"));
   backgroundTextures.push_back(loadTexture("./Assets/bgrd_tree5.png"));
  //  backgroundTextures.push_back(loadTexture("./Assets/bgrd_tree3.png"));
   // backgroundTextures.push_back(loadTexture("./Assets/bgrd_tree4.png"));
   backgroundTextures.push_back(loadTexture("./Assets/bgrd_tree2.png"));
      



    SDL_Texture* backgroundFloor = loadTexture("./Assets/mushroom forest bottom.png");
    SDL_Texture* backgroundSky = loadTexture("./Assets/main_background.png");
